...
export default function CandlesProductsPage() {
  return (
    <main className="page-gradient-sacral min-h-screen pt-[80px] flex items-center justify-center px-4">
      <div className="text-center">
        <p className="font-display text-2xl text-[--text-primary] mb-3">Candles Collection</p>
