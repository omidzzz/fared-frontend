...
export default function ClothesProductsPage() {
  return (
    <main className="page-gradient-root min-h-screen pt-[80px] flex items-center justify-center px-4">
      <div className="text-center">
        <p className="font-display text-2xl text-[--text-primary] mb-3">Clothing Collection</p>
