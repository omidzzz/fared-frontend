...
export default function ClothesCardV2({ id, name, price, image, properties }: ClothesCardV2Props) {
  ...
  return (
    <Link href={`/shop/clothes/${id}`} style={{ textDecoration: 'none', display: 'block' }}>
      <div
        style={{
          position: 'relative',
          borderRadius: '16px',
      ...
      >
        ...
        <img
          src="/images/ui/clothes-card-v2.svg"
          alt=""
          aria-hidden="true"
          style={{
